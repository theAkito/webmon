...
const val msgImplicitTlsSuccess = "Success via TLS."
const val msgExplicitTlsSuccess = "Success via STARTTLS."
const val msgBothTlsSuccess = "Success via TLS and STARTTLS."
